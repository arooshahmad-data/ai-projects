...
class ImageViewer(QWidget):
    ...
    Attributes:
    - base_folder_path: Path to the base folder containing images and texts subfolders.
    ...
    def initUI(self):
        ...
        # Text Editor box for text
        self.text_edit = QTextEdit(self)
        self.text_edit.setReadOnly(True)
        self.text_edit.setStyleSheet("font-size: 15px;")  # Set default font size to 15px
        self.text_edit.setFixedSize(1000, 150) # Set specific height and width.
        ...
        nav_button_layout.setSpacing(20)  # Set smaller spacing between buttons
        nav_button_layout.addWidget(self.prev_button)
        nav_button_layout.addWidget(self.next_button)
        nav_button_layout.setAlignment(Qt.AlignCenter)  # Center-align the buttons
    ...
    def select_base_folder(self):
        """Open a dialog to select the base folder."""
